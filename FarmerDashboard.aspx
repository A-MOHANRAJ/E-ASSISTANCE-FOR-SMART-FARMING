<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Layout_Farmer.Master" AutoEventWireup="true" CodeBehind="FarmerDashboard.aspx.cs" Inherits="Onliine_Agro_Products_System.FarmerDashboard" %>
...
<h3>Change Password</h3>
        ...
        <table>
            <tr>
                <td class="auto-style1"><strong>New Password</strong></td><td><strong><asp:TextBox ID="txtPassword" TextMode="Password" runat="server" Width="147px"></asp:TextBox></strong></td>
            </tr>
             <tr>
                <td class="auto-style1"><strong>Re-enter Password</strong></td><td><strong><asp:TextBox ID="txtRePassword" TextMode="Password" runat="server" Width="147px" ></asp:TextBox></strong></td>
            </tr>
                   <tr>
                ...
                <td><strong><asp:Button ID="btnSubmitPassword" Text="Change" runat="server" Width="83px"  style="font-weight: 700" OnClick="btnSubmitPassword_Click" OnClientClick="return ValidateAll()" /></strong></td>             
            </tr>
            <tr>
                <td colspan="2">
                    <strong>
