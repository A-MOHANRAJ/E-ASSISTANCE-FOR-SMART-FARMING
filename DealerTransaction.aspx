<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Layout_Dealer.Master" AutoEventWireup="true" CodeBehind="DealerTransaction.aspx.cs" Inherits="Onliine_Agro_Products_System.DealerTransaction" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3><asp:Label ID="lblheading" runat="server" Text="Product Requirement Transaction Details"></asp:Label> </h3>
   <table>
       <tr>
    ...
    <table>       
        <tr>
            ...
            <td class="auto-style1"><strong> Posted_On&nbsp;&nbsp;</strong></td><td><asp:Label ID="lblDate" runat="server" width="180px"></asp:Label></td>
        </tr>
          <tr>
            <td><strong> Requirement&nbsp;&nbsp;</strong> </td><td><asp:Label ID="lblSellingQty" runat="server" width="180px" ></asp:Label></td>
              <td class="auto-style1"><strong> Unit&nbsp;&nbsp;</strong> </td><td><asp:Label ID="lblUnit" runat="server" width="180px" ></asp:Label></td>
        </tr>
          <tr>
            <td><strong> Received &nbsp;&nbsp;</strong> </td><td><asp:Label ID="lblSoldQty" runat="server" width="180px"></asp:Label></td>
              <td class="auto-style1"><strong> Status&nbsp;&nbsp;</strong> </td><td><asp:Label ID="lblStatus" runat="server" width="180px"></asp:Label></td>
        </tr>
    </table>
    <br />
   <div class="subheader">   <span>Farmer Transaction</span> </div> <br />
    <asp:GridView ID="gridProduct" runat="server" AutoGenerateColumns="false" ShowFooter="false" PageSize="10" AllowPaging="true" CssClass="mydatagrid" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" Width="517px" EmptyDataText="No Records Found" OnPageIndexChanging="gridProduct_PageIndexChanging">
        <Columns>
            ...
            <asp:TemplateField ItemStyle-Width="50px" HeaderText="Farmer">
                <ItemTemplate>
