<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Layout_Farmer.Master" AutoEventWireup="true" CodeBehind="FarmerApprovals.aspx.cs" Inherits="Onliine_Agro_Products_System.FarmerApprovals" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <strong>
        ...
        <strong style="color:orangered">Check the <a href="FarmerDashboard.aspx" target="_blank">product status</a>  before approve</strong>
