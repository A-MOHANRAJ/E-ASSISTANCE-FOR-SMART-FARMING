<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Layout_Dealer.Master" AutoEventWireup="true" CodeBehind="DealerRequests.aspx.cs" Inherits="Onliine_Agro_Products_System.DealerRequests" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>My Requests</h3> 
    <asp:Panel  style="width:535px" runat="server">
<asp:GridView ID="gridProduct" runat="server" AutoGenerateColumns="false" ShowFooter="false" PageSize="10" 
    ...
    <asp:TemplateField HeaderText="S.No" ItemStyle-Width="7px">
            ...
            <asp:TemplateField ItemStyle-Width="50px" HeaderText="Req.Qty">
                <ItemTemplate>
