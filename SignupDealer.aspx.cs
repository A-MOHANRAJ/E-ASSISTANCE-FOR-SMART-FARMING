...
{
    public partial class SignupDealer : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string checkExists = "select * from " + ConfigurationManager.AppSettings["Dealer_Info"].ToString() + " where Email='" + txtEmail.Text + "'" +
                ...
                {
                    fieldValueList.Add("Master_Type_ID", "3");
                    fieldValueList.Add("Name", "'" + txtDealerName.Text + "'");
                    ...
                    fieldValueList.Add("Office_Name", "'" + txtOffName.Text + "'");
                    fieldValueList.Add("Office_Address", "'" + txtOffAddress.Text + "'");
                    ...
                    resultList = businessLogic.InsertRecord(ConfigurationManager.AppSettings["Dealer_Info"].ToString(), fieldValueList);
                    if (resultList.Count > 1)
                    {
                        lblMsg.Text = "Hi," + txtDealerName.Text + " you have successfully registered";
                        lblMsg.ForeColor = System.Drawing.Color.Green;
                        linkRedirect.Visible = true;
                        linkRedirect.PostBackUrl = "~/DealerDashboard.aspx?mode=normal&id=" + resultList[1];
                        Session["Id"] = resultList[1];
                        Session["Master_Type_ID"] = "3";
                        Session["Name"] = txtDealerName.Text.ToString();
