<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Layout_Dealer.Master" AutoEventWireup="true" CodeBehind="RequestProduct.aspx.cs" Inherits="Onliine_Agro_Products_System.RequestProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h3><asp:Label ID="lblheading" runat="server" Text="Request Product"></asp:Label> </h3>
    <div>
        <table >
            <tr>
            ...
            <tr>
                ...
                <td><strong><asp:TextBox ID="txtQty" runat="server" Width="247px" Height="26px" 
onkeypress="return onlyNumbers(event)"></asp:TextBox></strong></td>
            </tr>
              <tr>
