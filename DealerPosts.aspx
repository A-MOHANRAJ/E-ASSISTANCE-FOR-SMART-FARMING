<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Layout_Common.Master" UnobtrusiveValidationMode="None" AutoEventWireup="true" CodeBehind="DealerPosts.aspx.cs" Inherits="Onliine_Agro_Products_System.DealerPosts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <% if (string.IsNullOrEmpty(Session["Master_Type_ID"] as string))
        ...
        { %>
    <i style="color: maroon; display: block; background-color: khaki">Only Farmers are allowed to send Request</i><%} %>
    <%if (dataAvailable)
        { %>
            ...
            <ItemTemplate>
                <div style="width: 100%; border: 1px solid goldenrod; padding: 5px; background-color: ghostwhite; line-height: 23px">
                    ...
                    <div style="padding: 2px">
                        <span style="font-size: 13px; font-weight: 600">Posted Qty:&nbsp;&nbsp</span><span style="color: blue; font-weight: 600"><%# Eval("Request_Qty") %>&nbsp;<%# Eval("Unit") %>&nbsp;</span>
                        <span style="font-size: 13px; font-weight: 600">Current Required Qty:&nbsp;&nbsp</span><span style="color: forestgreen; font-weight: 600"><asp:Label ID="lblavailbleQty" runat="server" Text='<%# Eval("ToBuy") %>'></asp:Label>
                            &nbsp;<%# Eval("Unit") %>&nbsp </span>
                    </div>

                    <span style="font-size: 13px; font-weight: 600">State:&nbsp;&nbsp</span><%# Eval("State_Name") %>
                    <div style="padding: 2px">
                        <span style="font-size: 13px; font-weight: 600">Dealer:&nbsp;&nbsp</span><%# Eval("Name") %>&nbsp;&nbsp; 
                        <span style="font-size: 13px; font-weight: 600">Office Name:&nbsp;&nbsp</span><%# Eval("Office_Name") %>
                    </div>
                    ...
                    <div style="padding: 2px">
                        <span style="font-size: 13px; font-weight: 600">Office Address:&nbsp;&nbsp</span><%# Eval("Office_Address") %>&nbsp;&nbsp;
                    </div>
                    <div style="padding: 2px">
                        ...
                        <div style="padding: 2px">
                            <span style="font-size: 13px; font-weight: 600">Remarks:&nbsp;&nbsp</span><%# Eval("Remarks") %>&nbsp;&nbsp;
                 <% if (string.IsNullOrEmpty(Session["Master_Type_ID"] as string))
                     { %>
                            ...
                            <div style="text-align: right">
                                <span style="font-size: 13px; font-weight: 600">Propose Qty:&nbsp;</span>&nbsp;<asp:TextBox ID="txtQty" runat="server" BorderStyle="Solid" BorderWidth="2px"
                                    BorderColor="#0099cc" Width="90" Height="30" TextMode="Number"></asp:TextBox>
                                &nbsp;&nbsp;
                                <asp:Button ID="btnPopup" runat="server"
                                    Text="Send Request" Font-Bold="true" BackColor="#66ff66" CommandName="request" CommandArgument='<%#Eval("FP_ID")+","+ Eval("UNT_ID")+","+ Eval("ToBuy")%>' />
                            </div>
                            <%} %>
                        </div>
                    </div>
